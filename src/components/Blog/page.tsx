        ...
        <section className="pb-10 bg-white">
            <div className="container mx-auto px-4">
                ...
                <div className="text-center mb-16">
                    <span className="text-[#f5a623] uppercase tracking-widest text-sm font-semibold inline-block mb-2">
                        From the Blog
                    </span>
                        ...
                        <div key={post.id} className="bg-gray-200 rounded-2xl shadow-lg overflow-hidden">
                            <div className="bg-white rounded-b-2xl">
                                <div className="relative">
                                    ...
                                    />
                                    {/* Date Badge */}
                                    <div className="absolute top-4 right-4 bg-[#f5a623] text-white px-3 py-1 text-sm font-semibold rounded">
                                        {post.date}
                                    </div>
                                </div>
                                ...
                                <div className="flex justify-between items-center text-sm text-gray-500 px-6 py-3 bg-gray-200">
                                    <a href="#" className="flex items-center space-x-1 hover:text-[#f5a623]">
                                        <span>Read More</span>
                                        <span><ArrowRight className="w-4 h-4 text-[#f5a623]"/></span>
                                    </a>
                                    <span className="flex items-center space-x-1">
