    ...
    <footer className="bg-black text-white py-16 px-6 lg:px-20">
      <div className="max-w-7xl mx-auto grid gap-12 lg:grid-cols-3">
        ...
        <div>
          ...
          <h2 className="flex items-center content-center items-center gap-2 text-4xl sm:text-5xl font-semibold  leading-tight">
          ...
          <div className="mt-10 flex  max-w-xl bg-white rounded-full overflow-hidden">
            <input
              ...
              className="text-black flex-1 px-6 py-4 text-sm sm:text-base outline-none"
            />
            <button className="bg-black text-white m-1  px-3 py-3 text-sm sm:text-base rounded-full mr-1 hover:bg-white hover:text-black border border-black transition">
              GO
            </button>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800 mt-14 pt-6 text-center">
        <p className="text-gray-400 text-sm">Copyright © 2024 Templatebucket</p>
      </div>
    </footer>
  );
}
