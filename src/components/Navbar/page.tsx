...
import { ArrowRight, Hamburger, X } from "lucide-react";
...
const Navbar = () => {
    ...
    return (
        <nav className={`h-20 z-50 w-full fixed transition-all duration-500 ${isScrolled
            ...
            <div className={`container mx-auto h-20 flex justify-between items-center content-center transition-all duration-300 px-4 lg:px-0`}>
                <div className="flex gap-20">
                    {/* Logo */}
                    <Link href="/">
                        <h2 className={`text-4xl font-bold transition-all flex items-center gap-2 duration-300 ${isScrolled ? 'text-white' : 'text-white'
                            }`}>
                ...
                <div>
                    ...
                    <Link href="/login" className="hidden lg:flex">
                        <h2 className={`flex gap-2 items-center transition-all duration-300 hover:text-gray-300 bg-white rounded-full border border-white p-3 ${isScrolled ? 'text-black' : 'text-black'
                            }`}>
                ...
                <div className="lg:hidden flex items-center justify-between w-full">
                    <Link href="/">
                        <h2 className={`text-2xl font-bold transition-all duration-300 ${isScrolled ? 'text-white' : 'text-white'
                            }`}>Digital Agency</h2>
                    </Link>
                    <button
